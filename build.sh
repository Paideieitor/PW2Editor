...
CORE_CPP="System.cpp"
UTILS_CPP="Utils/DataUtils.cpp Utils/StringUtils.cpp Utils/FileUtils.cpp Utils/NDS/NarcUtils.cpp Utils/NDS/Alle5Format.cpp Utils/Intenal/KlinFormat.cpp Utils/Internal/KlangFormat.cpp Utils/NDS/NCLRFormat.cpp Utils/Internal/Image.cpp Utils/NDS/NCGRFormat.cpp"
WINDOWS_CPP="Windows/Window.cpp Windows/Wizard.cpp Windows/Engine.cpp Windows/Paint.cpp"
...
g++ PW2Editor.cpp ${COMPILE_FILES} ${INCLUDE_DIRS} ${LINK_FILES} ${COMPILE_FLAGS} -o PW2Editor
g++ PW2Paint.cpp ${COMPILE_FILES} ${INCLUDE_DIRS} ${LINK_FILES} ${COMPILE_FLAGS} -o PW2Paint
